...
<!-- STYLES -->
<link href="../../css2-2.css?family=Mulish:ital,wght@0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&family=Poppins:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap" rel="stylesheet">
<link href="../../css2-3.css?family=Montserrat:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap" rel="stylesheet">

<link rel="stylesheet" type="text/css" href="{{url('frontend/css/plugins.css')}}">
<link rel="stylesheet" type="text/css" href="{{url('frontend/css/dark.css')}}">
...
<div class="know_tm_all_wrap" data-magic-cursor="show"> <!-- If you want disable magic cursor change value to "hide" -->	
	...
	<div class="know_tm_modalbox">
		<div class="box_inner">
			<div class="close">
				<a href="#"><img class="svg" src="{{url('frontend/img/svg/cancel.svg')}}" alt=""></a>
			</div>
	...
	<div class="know_tm_topbar">
		<div class="container">
			<div class="topbar_inner">
				<div class="logo">
					<a href="#"><img src="{{url('frontend/img/logo/light.png')}}" alt=""></a>
				</div>
				<div class="right">
					<div class="social">
						<ul>
							<li><a href="#"><img class="svg" src="{{url('frontend/img/svg/social/facebook.svg')}}" alt=""></a></li>
							<li><a href="#"><img class="svg" src="{{url('frontend/img/svg/social/twitter.svg')}}" alt=""></a></li>
							<li><a href="#"><img class="svg" src="{{url('frontend/img/svg/social/youtube.svg')}}" alt=""></a></li>
							<li><a href="#"><img class="svg" src="{{url('frontend/img/svg/social/instagram.svg')}}" alt=""></a></li>
						</ul>
					</div>
					<div class="know_tm_button">
						<a href="{{url('frontend/img/cv/1.jpg')}}" download="">Download CV</a>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="know_tm_hero">
						...
						<div class="left">
							...
							<div class="know_tm_video">
								<div class="video_inner">
									...
									<a class="know_tm_full_link popup-youtube" href="../../watch-2.html?v=7e90gBu4pas"></a>
								</div>
							</div>
						</div>
						<div class="right">
							<div class="image">
								<img src="{{url('frontend/img/isha.jpg')}}" alt="">
								<div class="main" data-img-url="{{url('frontend/img/isha.jpg')}}"></div>
							</div>
						</div>
					</div>
					<div class="main_menu">
						<ul>
							<li>
								<img class="svg" src="{{url('frontend/img/svg/archive.svg')}}" alt="">
								<span>About Me</span>
								<a class="know_tm_full_link" href="#about"></a>
							</li>
							<li>
								<img class="svg" src="{{url('frontend/img/svg/contacs.svg')}}" alt="">
								<span>Resume</span>
								<a class="know_tm_full_link" href="#resume"></a>
							</li>
							<li>
								<img class="svg" src="{{url('frontend/img/svg/briefcase.svg')}}" alt="">
								<span>Portfolio</span>
								<a class="know_tm_full_link" href="#portfolio"></a>
							</li>
							<li>
								<img class="svg" src="{{url('frontend/img/svg/gear.svg')}}" alt="">
								<span>Service</span>
								<a class="know_tm_full_link" href="#service"></a>
							</li>
							<li>
								<img class="svg" src="{{url('frontend/img/svg/message.svg')}}" alt="">
								<span>Testimonial</span>
								<a class="know_tm_full_link" href="#testimonials"></a>
							</li>
							<li>
								<img class="svg" src="{{url('frontend/img/svg/writing.svg')}}" alt="">
								<span>Blog</span>
								<a class="know_tm_full_link" href="#news"></a>
							</li>
							<li>
								<img class="svg" src="{{url('frontend/img/svg/letter.svg')}}" alt="">
								<span>Contact</span>
		...
		<!-- Hero Shapes -->
		<span class="one anim_scale"><img class="svg" src="{{url('frontend/img/svg/shapes/9.svg')}}" alt=""></span>
		<span class="two anim_moveLeft"><img class="svg" src="{{url('frontend/img/svg/shapes/dot.svg')}}" alt=""></span>
		<span class="three anim_moveTop"><img class="svg" src="{{url('frontend/img/svg/shapes/dot-2.svg')}}" alt=""></span>
		<span class="four anim_circle"><img class="svg" src="{{url('frontend/img/svg/shapes/1.svg')}}" alt=""></span>
		<span class="five anim_circle"><img class="svg" src="{{url('frontend/img/svg/shapes/8.svg')}}" alt=""></span>
		<span class="six anim_circle"><img class="svg" src="{{url('frontend/img/svg/shapes/3.svg')}}" alt=""></span>
		<span class="seven anim_right"><img class="svg" src="{{url('frontend/img/svg/shapes/4.svg')}}" alt=""></span>
		<span class="eight anim_scale"><img class="svg" src="{{url('frontend/img/svg/shapes/9.svg')}}" alt=""></span>
		<span class="nine anim_circle"><img class="svg" src="{{url('frontend/img/svg/shapes/3.svg')}}" alt=""></span>
		<span class="ten anim_moveLeft"><img class="svg" src="{{url('frontend/img/svg/shapes/4.svg')}}" alt=""></span>
		<span class="eleven anim_scale"><img class="svg" src="{{url('frontend/img/svg/shapes/9.svg')}}" alt=""></span>
		<span class="twelve anim_extra"><img class="svg" src="{{url('frontend/img/svg/shapes/2.svg')}}" alt=""></span>
		<span class="thirteen anim_circle"><img class="svg" src="{{url('frontend/img/svg/shapes/5.svg')}}" alt=""></span>
		<span class="fourteen anim_scale"><img class="svg" src="{{url('frontend/img/svg/shapes/9.svg')}}" alt=""></span>
		<span class="fifteen anim_circle"><img class="svg" src="{{url('frontend/img/svg/shapes/3.svg')}}" alt=""></span>
		<span class="sixteen anim_scale"><img class="svg" src="{{url('frontend/img/svg/shapes/9.svg')}}" alt=""></span>
		<span class="seventeen anim_circle"><img class="svg" src="{{url('frontend/img/svg/shapes/5.svg')}}" alt=""></span>
		<span class="eighteen anim_scale"><img class="svg" src="{{url('frontend/img/svg/shapes/9.svg')}}" alt=""></span>
		<span class="nineteen anim_scale"><img class="svg" src="{{url('frontend/img/svg/shapes/9.svg')}}" alt=""></span>
		<span class="twenty anim_circle"><img class="svg" src="{{url('frontend/img/svg/shapes/1.svg')}}" alt=""></span>
		<!-- /Hero Shapes -->
				...
				<div class="know_tm_about">
					<div class="left">
						<div class="left_inner">
							<div class="image">
								<img src="{{url('frontend/img/thumbs/35-44.jpg')}}" alt="">
								<div class="main" data-img-url="{{url('frontend/img/about/1.jpg')}}"></div>
							</div>
							<div class="details">
								<ul>
									<li>
									...
									<li>
										<h3>Mail</h3>
										<span><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="5b333e3737341b3a353f3e2928343575383436">[email&#160;protected]</a></span>
									</li>
									<li>
										<h3>Phone</h3>
					...
					<div class="portfolio_list">
						<ul class="gallery_zoom">
							<li class="vimeo">
								<div class="list_inner">
									<div class="image">
										<img src="{{url('frontend/img/thumbs/1-1.jpg')}}" alt="">
										<div class="main" data-img-url="{{url('frontend/img/portfolio/1.jpg')}}"></div>
									</div>
									<div class="overlay"></div>
									<img class="svg" src="{{url('frontend/img/svg/social/vimeo.svg')}}" alt="">
									<div class="details">
										<span>Vimeo</span>
										<h3>Aumeo Audio</h3>
									</div>
							...
							<li class="youtube">
								<div class="list_inner">
									<div class="image">
										<img src="{{url('frontend/img/thumbs/1-1.jpg')}}" alt="">
										<div class="main" data-img-url="{{url('frontend/img/portfolio/2.jpg')}}"></div>
									</div>
									<div class="overlay"></div>
									<img class="svg" src="{{url('frontend/img/svg/social/youtube-2.svg')}}" alt="">
									<div class="details">
										<span>Youtube</span>
										<h3>Bicker &amp; Jenna</h3>
									</div>
							...
							<li class="soundcloud">
								<div class="list_inner">
									<div class="image">
										<img src="{{url('frontend/img/thumbs/1-1.jpg')}}" alt="">
										<div class="main" data-img-url="{{url('frontend/img/portfolio/3.jpg')}}"></div>
									</div>
									<div class="overlay"></div>
									<img class="svg" src="{{url('frontend/img/svg/social/soundcloud.svg')}}" alt="">
									<div class="details">
										<span>Soundcloud</span>
										<h3>Botanical Escape</h3>
									</div>
									<a class="know_tm_full_link soundcloude_link mfp-iframe audio" href="../../player/index-1.htm?url=https%3A//api.soundcloud.com/tracks/471954807&color=%23ff5500&auto_play=true&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"></a>
								</div>
							</li>
							<li class="youtube">
								<div class="list_inner">
									<div class="image">
										<img src="{{url('frontend/img/thumbs/1-1.jpg')}}" alt="">
										<div class="main" data-img-url="{{url('frontend/img/portfolio/6.jpg')}}"></div>
									</div>
									<div class="overlay"></div>
									<img class="svg" src="{{url('frontend/img/svg/social/youtube-2.svg')}}" alt="">
									<div class="details">
									...
									<a class="know_tm_full_link popup-youtube" href="../../watch-3.html?v=l-epKcOA7RQ"></a>
								</div>
							</li>
							<li class="vimeo">
								<div class="list_inner">
									<div class="image">
										<img src="{{url('frontend/img/thumbs/1-1.jpg')}}" alt="">
										<div class="main" data-img-url="{{url('frontend/img/portfolio/7.jpg')}}"></div>
									</div>
									<div class="overlay"></div>
									<img class="svg" src="{{url('frontend/img/svg/social/vimeo.svg')}}" alt="">
									<div class="details">
									...
									<a class="know_tm_full_link popup-vimeo" href="../../337292310-1.html"></a>
								</div>
							</li>
							<li class="detail">
								<div class="list_inner">
									<div class="image">
										<img src="{{url('frontend/img/thumbs/1-1.jpg')}}" alt="">
										<div class="main" data-img-url="{{url('frontend/img/portfolio/8.jpg')}}"></div>
									</div>
									<div class="overlay"></div>
									<img class="svg" src="{{url('frontend/img/svg/text.svg')}}" alt="">
									<div class="details">
										<span>Detail</span>
										<h3>Teresa Melbig</h3>
									</div>
													...
													<ul>
														...
														<li>
															...
															<ul class="share">
																<li><a href="#"><img class="svg" src="{{url('frontend/img/svg/social/facebook.svg')}}" alt=""></a></li>
																<li><a href="#"><img class="svg" src="{{url('frontend/img/svg/social/twitter.svg')}}" alt=""></a></li>
																<li><a href="#"><img class="svg" src="{{url('frontend/img/svg/social/instagram.svg')}}" alt=""></a>
																</li>
															</ul>
														</li>
													</ul>
											...
											<div class="additional_images">
												<ul>
													<li>
														<div class="list_inner">
															<div class="my_image">
																<img src="{{url('frontend/img/thumbs/4-2.jpg')}}" alt="">
																<div class="main" data-img-url="{{url('frontend/img/portfolio/1.jpg')}}"></div>
															</div>
														</div>
													</li>
				...
				<div class="know_tm_services">
					...
					<div class="service_list">
						<ul>
							<li>
								<div class="list_inner">
									<span class="icon"><img class="svg" src="{{url('frontend/img/svg/squares.svg')}}" alt=""></span>
									...
									<div class="hidden_content">
										<div class="service_informations">
											<div class="image">
												<img src="{{url('frontend/img/thumbs/4-2.jpg')}}" alt="">
												<div class="main" data-img-url="{{url('frontend/img/service/1.jpg')}}"></div>
											</div>
							...
							<li>
								<div class="list_inner">
									<span class="icon"><img class="svg" src="{{url('frontend/img/svg/physics.svg')}}" alt=""></span>
									...
									<div class="hidden_content">
										<div class="service_informations">
											<div class="image">
												<img src="{{url('frontend/img/thumbs/4-2.jpg')}}" alt="">
												<div class="main" data-img-url="{{url('frontend/img/service/2.jpg')}}"></div>
											</div>
											<div class="description">
												<p>Know is a leading web design agency with an award-winning design team that creates innovative, effective websites that capture your brand, improve your conversion rates, and maximize your revenue to help grow your business and achieve your goals.</p>
												<p>In today’s digital world, your website is the first interaction consumers have with your business. That's why almost 95 percent of a user’s first impression relates to web design. It’s also why web design services can have an immense impact on your company’s bottom line.</p>
							...
							<li>
								<div class="list_inner">
									<span class="icon"><img class="svg" src="{{url('frontend/img/svg/web.svg')}}" alt=""></span>
									...
									<div class="hidden_content">
										<div class="service_informations">
											<div class="image">
												<img src="{{url('frontend/img/thumbs/4-2.jpg')}}" alt="">
												<div class="main" data-img-url="{{url('frontend/img/service/3.jpg')}}"></div>
											</div>
											<div class="description">
												<p>Know is a leading web design agency with an award-winning design team that creates innovative, effective websites that capture your brand, improve your conversion rates, and maximize your revenue to help grow your business and achieve your goals.</p>
												<p>In today’s digital world, your website is the first interaction consumers have with your business. That's why almost 95 percent of a user’s first impression relates to web design. It’s also why web design services can have an immense impact on your company’s bottom line.</p>
								...
								<div class="list_inner">
									...
									<div class="hidden_content">
										<div class="service_informations">
											<div class="image">
												<img src="{{url('frontend/img/thumbs/4-2.jpg')}}" alt="">
												<div class="main" data-img-url="{{url('frontend/img/service/4.jpg')}}"></div>
											</div>
											<div class="description">
												<p>Know is a leading web design agency with an award-winning design team that creates innovative, effective websites that capture your brand, improve your conversion rates, and maximize your revenue to help grow your business and achieve your goals.</p>
												<p>In today’s digital world, your website is the first interaction consumers have with your business. That's why almost 95 percent of a user’s first impression relates to web design. It’s also why web design services can have an immense impact on your company’s bottom line.</p>
							...
							<li>
								<div class="list_inner">
									<span class="icon"><img class="svg" src="{{url('frontend/img/svg/briefcase.svg')}}" alt=""></span>
									...
									<div class="hidden_content">
										<div class="service_informations">
											<div class="image">
												<img src="{{url('frontend/img/thumbs/4-2.jpg')}}" alt="">
												<div class="main" data-img-url="{{url('frontend/img/service/5.jpg')}}"></div>
											</div>
											<div class="description">
												<p>Know is a leading web design agency with an award-winning design team that creates innovative, effective websites that capture your brand, improve your conversion rates, and maximize your revenue to help grow your business and achieve your goals.</p>
												<p>In today’s digital world, your website is the first interaction consumers have with your business. That's why almost 95 percent of a user’s first impression relates to web design. It’s also why web design services can have an immense impact on your company’s bottom line.</p>
							...
							<li>
								<div class="list_inner">
									<span class="icon"><img class="svg" src="{{url('frontend/img/svg/writing_2.svg')}}" alt=""></span>
									...
									<div class="hidden_content">
										<div class="service_informations">
											<div class="image">
												<img src="{{url('frontend/img/thumbs/4-2.jpg')}}" alt="">
												<div class="main" data-img-url="{{url('frontend/img/service/6.jpg')}}"></div>
											</div>
											<div class="description">
												<p>Know is a leading web design agency with an award-winning design team that creates innovative, effective websites that capture your brand, improve your conversion rates, and maximize your revenue to help grow your business and achieve your goals.</p>
												<p>In today’s digital world, your website is the first interaction consumers have with your business. That's why almost 95 percent of a user’s first impression relates to web design. It’s also why web design services can have an immense impact on your company’s bottom line.</p>
						...
						<div class="list_inner">
							<div class="in">
								...
								<div class="details">
									<div class="left">
										<div class="avatar">
											<div class="main" data-img-url="{{url('frontend/img/testimonials/1.jpg')}}"></div>
										</div>
										<div class="info">
											<h3>Jecob Oramson</h3>
											<span>Designer</span>
									...
									<div class="right">
										<img class="svg" src="{{url('frontend/img/svg/left-quote.svg')}}" alt="">
									</div>
								</div>
							</div>
						</div>
						<div class="list_inner">
							<div class="in">
								...
								<div class="details">
									<div class="left">
										<div class="avatar">
											<div class="main" data-img-url="{{url('frontend/img/testimonials/2.jpg')}}"></div>
										</div>
										<div class="info">
											<h3>Kerry Hudson</h3>
											<span>IBO. Corp</span>
						...
						<div class="list_inner">
							<div class="in">
								...
								<div class="details">
									<div class="left">
										<div class="avatar">
											<div class="main" data-img-url="{{url('frontend/img/testimonials/3.jpg')}}"></div>
										</div>
										<div class="info">
											<h3>Albert Walker</h3>
											<span>Singer</span>
						...
						<div class="list_inner">
							<div class="in">
								...
								<div class="details">
									<div class="left">
										<div class="avatar">
											<div class="main" data-img-url="{{url('frontend/img/testimonials/4.jpg')}}"></div>
										</div>
										<div class="info">
						...
						<div class="list_inner">
							<div class="in">
								...
								<div class="details">
									<div class="left">
										<div class="avatar">
											<div class="main" data-img-url="{{url('frontend/img/testimonials/5.jpg')}}"></div>
										</div>
										<div class="info">
											<h3>Aura Brooklyn</h3>
					...
					<div class="news_list">
						<ul>
							<li>
								<div class="list_inner">
									<div class="image">
										<img src="{{url('frontend/img/thumbs/37-27.jpg')}}" alt="">
										<div class="main" data-img-url="{{url('frontend/img/news/1.jpg')}}"></div>
										<a class="know_tm_full_link" href="#"></a>
									</div>
									<div class="details">
							...
							<li>
								<div class="list_inner">
									<div class="image">
										<img src="{{url('frontend/img/thumbs/37-27.jpg')}}" alt="">
										<div class="main" data-img-url="{{url('frontend/img/news/2.jpg')}}"></div>
										<a class="know_tm_full_link" href="#"></a>
									</div>
									<div class="details">
							...
							<li>
								<div class="list_inner">
									<div class="image">
										<img src="{{url('frontend/img/thumbs/37-27.jpg')}}" alt="">
										<div class="main" data-img-url="{{url('frontend/img/news/3.jpg')}}"></div>
										<a class="know_tm_full_link" href="#"></a>
									</div>
									<div class="details">
					...
					<div class="wrapper">
						<div class="left">
							<ul>
								<li>
									<div class="list_inner">
										<span class="icon"><img class="svg" src="{{url('frontend/img/svg/smartphone.svg')}}" alt=""></span>
										<div class="short">
											<h3>Call Me</h3>
											<span>+123 456 7890</span>
										</div>
								...
								<li>
									<div class="list_inner">
										<span class="icon"><img class="svg" src="{{url('frontend/img/svg/letter.svg')}}" alt=""></span>
										<div class="short">
											<h3>Email Us</h3>
								...
								<li>
									<div class="list_inner">
										<span class="icon"><img class="svg" src="{{url('frontend/img/svg/placeholder.svg')}}" alt=""></span>
										<div class="short">
											<h3>Address</h3>
...
<!-- SCRIPTS -->
<script data-cfasync="false" src="../../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min-1.js"></script><script src="{{url('frontend/js/jquery.js')}}"></script>
